...
<div class="leftnav">
  ...
  <ul style="display:block">
    <li><a href="<%=path%>/single?method=getSubjectList" target="right"><span class="icon-caret-right"></span>在线考试</a></li>
 <li><a href="<%=path%>/grade?method=history" target="right"><span class="icon-caret-right"></span>成绩管理</a></li>
  </ul>   
